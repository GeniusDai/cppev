...
int main(int argc, char **argv) {
    ...
    LOG_ERROR << std::string("LOG_ERROR Message");

    auto logging_task = []() {
        // Formatted logging
        LOG_DEBUG_FMT("LOG_DEBUG_FMT Message : %s %d", "thread", std::this_thread::get_id());
        LOG_INFO_FMT("LOG_INFO_FMT Message : %s %d", "thread", std::this_thread::get_id());
        LOG_WARNING_FMT("LOG_WARNING_FMT Message : %s %d", "thread", std::this_thread::get_id());
        LOG_ERROR_FMT("LOG_ERROR_FMT Message : %s %d", std::string("thread").c_str(), std::this_thread::get_id());
    };
